...
<?php
    ...
    $instagram = theme_get_setting('instagram_account');
?>
        ...
        <div class="wrapper">
            ...
            <center>
                <?php if(theme_get_setting('enable_socials','md_boom') == '1'):?>
                    <?php if($twitter_acc != null || $skype_acc != null || $facebook_acc != null || $youtube_channel != null || $gplus != null || $linkedin != null || $pinterest != null || $dribbble != null || $instagram !=null ):?>
			...
			<?php if($instagram != null):?><li class="flx-instagram-icon"><a href="<?php print $instagram;?>" target="_blank"></a></li><?php endif;?>
                    </ul>
                    <?php endif;?>
                <?php endif;?>
            </center>
